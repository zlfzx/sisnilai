...
<head>
    ...
    <!-- Bootstrap 3.3.7 -->
<script src="<?= base_url('__/adminlte/bower_components/bootstrap/dist/js/bootstrap.min.js');?>"></script>
</head>
<body class="login-page">

    <div class="login-box">
        <div class="login-box-body">
            <h1 class="text-center login-box-msg"><i>Administrator</i></h1>
            ...
            <form action="<?=base_url('a_login/actlogin');?>" method="post">
                ...
                <button type="submit" class="btn btn-warning btn-block btn-flat"><i class="fa fa-sign-in"></i> Login</button>
            </form>
        </div>
    </div>
